...
int testHexString() {
    ...
    uint16_t val2 = 12345;
    expected = "39 30";
    hexString = HexString(val2, true, false);
    assert(!strcmp(hexString.c_str(), expected.c_str()));
    std::cout << "\nTest Val: " << val2 << ", Hex Representation: " << hexString << std::endl;

    hexString = HexString(val2, false, false);
    expected = "3930";
    assert(!strcmp(hexString.c_str(), expected.c_str()));
    ...
    hexString = HexString(val3, true, false);
    assert(!strcmp(hexString.c_str(), expected.c_str()));
    std::cout << "\nTest Val: " << val3 << ", Hex Representation: " << hexString << std::endl;

    hexString = HexString(val3, false, false);
    expected = "D2029649";
    assert(!strcmp(hexString.c_str(), expected.c_str()));
    ...
    hexString = HexString(val4, true, false);
    assert(!strcmp(hexString.c_str(), expected.c_str()));
    std::cout << "\nTest Val: " << val4 << ", Hex Representation: " << hexString << std::endl;

    hexString = HexString(val4, false, false);
